export class View {
    constructor(api) {
        ...
        this.searchInput.placeholder = 'Введите имя пользователя';
    ...
    createUserDataBlock(list, title) {
        ...
        const blockList = this.createElement('lu', 'block-list');
